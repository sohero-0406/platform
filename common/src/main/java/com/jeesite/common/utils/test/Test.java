package com.jeesite.common.utils.test;

import com.jeesite.common.utils.word.CustomXWPFDocument;
import com.jeesite.common.utils.word.OfficeForPOIUtil;
...
//		picture1.put("content", WorderToNewWordUtils.inputStream2ByteArray(new FileInputStream("template/c1.jpg"), true));
		...
		CustomXWPFDocument document = new CustomXWPFDocument(POIXMLDocument.openPackage("E:/word.docx"));
		OfficeForPOIUtil.replaceInPara(document, data);
//		OfficeForPOIUtil.changeTable(document, data);

		//生成新的word
		String outputUrl = "E:/呵呵.docx";
...
//		FileOutputStream fopts = new FileOutputStream("E:/呵呵.docx");
//		doc.write(fopts);
//		fopts.close();
	}
}